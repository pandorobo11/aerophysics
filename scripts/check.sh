...
run_step "Normal test suite and coverage gates" bash scripts/check-coverage.sh
...
run_step "Verify clean wheel and sdist installations" \
    env AEROPHYSICS_TEST_ARTIFACT_DIRECTORY=dist \
