...
FLIGHT_COLUMNS = (
    ...
    Column("reynolds_number_per_length", "Reynolds数/長さ", "inverse_length"),
...
ISENTROPIC_COLUMNS = (
    ...
    Column("static_pressure", "静圧 p", "pressure"),
    Column("static_density", "静密度 ρ", "density"),
    Column("velocity", "速度 V", "speed"),
    Column("speed_of_sound", "音速 a", "speed"),
    Column("dynamic_pressure", "動圧 q", "pressure"),
